...
export function RangeSetter(
  ...
  return (
    <div className="flex flex-row gap-1 items-center" id={id}>
      ...
      <InputNumber
        ...
        className=" flex-1  h-8 focus-visible:shadow-none mr-2"
        type="number"
      />
      ...
      <InputNumber
        ...
        className=" flex-1 h-8 focus-visible:shadow-none"
        type="number"
      />
    </div>
  )
