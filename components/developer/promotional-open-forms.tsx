...
const openForms = [
  ...
  { icon: Gamepad2, title: "Webhooks", description: "提交、发布等事件实时回调" },
  { icon: Video, title: "OpenAPI 自渲染", description: "根据规范自动生成问卷 UI" },
  { icon: Code, title: "多语言 SDK", description: "JS/TS/Python/PHP 示例与封装" },
]
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4 text-balance">多种开放形态 助力快速接入问卷能力</h2>
        </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-4 max-w-sm mx-auto">
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-100 rounded-lg p-3">
                    <div className="text-xs text-gray-500 mb-2">搜索你感兴趣的内容和用户</div>
                    <div className="flex gap-2 text-xs">
                      <span className="bg-white px-2 py-1 rounded">关注</span>
                      <span className="bg-white px-2 py-1 rounded">推荐</span>
                      <span className="bg-blue-600 text-white px-2 py-1 rounded">直播</span>
                    </div>
                  </div>
