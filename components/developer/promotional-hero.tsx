...
export function PromotionalHero() {
	return (
		<section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-background py-20">
					...
					<div className="space-y-8">
						<div className="space-y-4">
							...
							<p className="text-lg text-muted-foreground leading-relaxed text-pretty">
								标准化 REST / tRPC
								能力，覆盖问卷创建、配置、发布、数据获取、回调事件与导出。
								一键获取 OpenAPI，快速对接，多端自渲染与移动端 SDK
								助力集成提效。
							</p>
						</div>
