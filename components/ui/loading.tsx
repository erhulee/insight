...
// 加载主题类型
export type LoadingTheme = 'default' | 'primary' | 'secondary' | 'success' | 'warning' | 'error'
...
export const Loading = ({
  ...
  const renderLoadingContent = () => {
    switch (variant) {
      case 'spinner':
        return <LoadingSpinner size={sizeMap[size]} className={cn('text-foreground', className)} />
      case 'dots':
