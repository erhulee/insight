...
import { deletePage, insertPage, runtimeStore, setCurrentPage } from "@/app/dashboard/_valtio/runtime"
            ...
            <AlertDialog open={dialogOpen}>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => realDelete(dialogPageIndexRef.current)} >确认删除</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
