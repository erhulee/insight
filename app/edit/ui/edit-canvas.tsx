...
import { EditQuestionItem } from './edit-question-item'
...
export const Canvas: React.FC = () => {
    ...
    const questionsList = questions as unknown as QuestionSchemaType[]
                        ...
                        {questionsList.length === 0 ? (
                            ...
                            questionsList.map((question, index) => (
                                <EditQuestionItem
                                    ...
                                    onSelect={() => handleSelectQuestion(question as QuestionSchemaType)}
