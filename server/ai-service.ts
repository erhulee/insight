...
function generateSurveyByPrompt(prompt: string): GeneratedSurvey {
    ...
    } else if (lowerPrompt.includes('市场调研') || lowerPrompt.includes('产品需求')) {
        return generateMarketResearchSurvey()
    } else if (lowerPrompt.includes('活动反馈') || lowerPrompt.includes('活动评价')) {
        ...
        questions: [
            {
                ...
                props: {
                    options: [
                        { label: '非常满意', value: 'very_satisfied', id: 'opt_very_satisfied' },
                        ...
                        { label: '非常不满意', value: 'very_dissatisfied', id: 'opt_very_dissatisfied' }
                    ]
                }
            },
            {
    ...
    return {
        ...
        questions: [
            ...
            },
            {
                ...
                props: {
                    options: [
                        { label: '薪资福利', value: 'compensation', id: 'opt_compensation' },
                        { label: '工作环境', value: 'work_environment', id: 'opt_work_environment' },
                        { label: '团队协作', value: 'teamwork', id: 'opt_teamwork' },
                        { label: '职业发展', value: 'career_development', id: 'opt_career_development' },
                        { label: '工作生活平衡', value: 'work_life_balance', id: 'opt_work_life_balance' },
    ...
    return {
        ...
        questions: [
            ...
            },
            {
                ...
                props: {
                    options: [
                        { label: '非常愿意', value: 'very_willing', id: 'opt_very_willing' },
    ...
    return {
        ...
        questions: [
            ...
            },
            {
                ...
                props: {
                    options: [
                        { label: '活动组织', value: 'organization', id: 'opt_organization' },
